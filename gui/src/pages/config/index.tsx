  ...
  return (
    <div className="flex h-full flex-row overflow-hidden">
      ...
      <div className="bg-vsc-background flex w-12 flex-shrink-0 flex-col border-0 md:w-40">
        <div className="thin-scrollbar border-r-border flex flex-1 flex-col overflow-y-auto border-b-0 border-l-0 border-r-2 border-t-0 border-solid p-2 text-xs">
