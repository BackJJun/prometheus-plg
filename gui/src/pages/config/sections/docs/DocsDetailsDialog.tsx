      ...
      comp = (
        <div className="flex flex-col gap-0.5">
          ...
          {!data.chunks?.length ? (
            ...
            <div className="thin-scrollbar relative mt-2 h-[300px] overflow-auto">
              <table className="w-full border-collapse">
                ...
                <tbody className="thin-scrollbar h-20 overflow-y-scroll">
                ...
                return (
                  <>
                    ...
                    <Tooltip
                      ...
                      id={contentToolTipId}
                      place="top"
                      className="thin-scrollbar max-h-[300px] max-w-[170px] overflow-y-auto"
                    >
                      {chunk.content}
                    </Tooltip>
                  </>
