    ...
    <Listbox value={selectedProvider} onChange={setSelectedProvider}>
      <div className="relative mb-2 mt-1">
        ...
        <Transition
          ...
          leaveTo="opacity-0"
        >
          <ListboxOptions className="thin-scrollbar bg-input rounded-default absolute left-0 top-full z-10 mt-1 h-fit w-3/5 overflow-y-auto p-0 focus:outline-none [&]:!max-h-[30vh]">
            {topOptions.length > 0 && (
              <div className="py-1">
