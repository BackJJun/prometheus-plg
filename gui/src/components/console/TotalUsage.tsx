  ...
  return (
    <div className="border-b border-[color:var(--vscode-panel-border)] p-4">
      ...
      {showCostBreakdown && totalUsage.costBreakdowns.length > 0 && (
        <div className="thin-scrollbar mb-4 max-h-32 overflow-y-auto rounded border border-[color:var(--vscode-panel-border)] bg-[color:var(--vscode-editor-background)] p-3">
