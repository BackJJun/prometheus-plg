  ...
  return (
    <>
      <div
        ...
        className={`find-widget-skip bg-vsc-input-background flex select-none flex-row items-center justify-between gap-1 pt-1 ${props.hidden || isLoginDialogOpen ? "pointer-events-none h-0 cursor-default opacity-0" : "pointer-events-auto mt-2 cursor-text opacity-100"}`}
        style={{
          fontSize: smallFont,
        }}
      >
        <div className="xs:gap-1.5 flex flex-row items-center gap-1">
          ...
          <div className="2xs:flex text-description -mb-1 hidden items-center transition-colors duration-200">
            {/* Image attachment is temporarily disabled. */}
