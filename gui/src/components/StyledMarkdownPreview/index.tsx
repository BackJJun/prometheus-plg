...
const StyledMarkdown = styled.div<{
  ...
  table.markdown-table thead tr {
    border-bottom: 1px solid rgba(127, 127, 127, 0.2);
  }

  table.markdown-table tbody tr {
  ...
  table.markdown-table th:nth-child(1),
  table.markdown-table td:nth-child(1) {
    width: 20%;
  }

  table.markdown-table th:nth-child(2),
  table.markdown-table td:nth-child(2) {
    width: 28%;
  }

  table.markdown-table th:nth-child(3),
  table.markdown-table td:nth-child(3) {
    width: 52%;
  }

  table.markdown-table th:first-child,
  table.markdown-table td:first-child {
    padding-left: 0;
  }
