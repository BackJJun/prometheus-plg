...
export type SecurityCheckMode = "automatic" | "askFirst" | "off";
export type SecurityFixMode = "automatic" | "manual" | "off";
export type SecurityDisplayMode = "preview" | "editor";
...
type UIState = {
  ...
  ttsActive: boolean;
  securityCheckMode: SecurityCheckMode;
  securityFixMode: SecurityFixMode;
...
export const DEFAULT_UI_SLICE: UIState = {
  ...
  ruleSettings: {},
  securityCheckMode: "askFirst",
  securityFixMode: "manual",
  securityDisplayMode: "preview",
};
...
export const uiSlice = createSlice({
  ...
  reducers: {
    ...
    setShowDialogCloseButton: (
      state,
      action: PayloadAction<UIState["showDialogCloseButton"]>,
    ) => {
      state.showDialogCloseButton = action.payload;
    },
    ...
    setSecurityCheckMode: (
      state,
      { payload }: PayloadAction<SecurityCheckMode>,
    ) => {
      state.securityCheckMode = payload;
    },
    setSecurityFixMode: (
      state,
      { payload }: PayloadAction<SecurityFixMode>,
    ) => {
      state.securityFixMode = payload;
    },
    setSecurityDisplayMode: (
      state,
      { payload }: PayloadAction<SecurityDisplayMode>,
    ) => {
      state.securityDisplayMode = payload;
    },
  },
});
