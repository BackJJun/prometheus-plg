...
const CHANGES_DESCRIPTION =
  "The COMPLETE modified file content. Do NOT wrap this in a codeblock or write anything besides the code. You MUST output the ENTIRE file content, NOT just the changed parts. Do NOT use placeholder comments like '// ... existing code ...' or '// ... rest of code ...' - these will cause code loss.";
