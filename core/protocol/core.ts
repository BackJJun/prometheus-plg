...
export type ToCoreFromIdeOrWebviewProtocol = {
  ...
  "history/delete": [{ id: string; accessToken?: string | null }, void];
  "history/load": [{ id: string; accessToken?: string | null }, Session];
  "history/loadLast": [
    { workspaceDirectory: string; accessToken?: string | null },
    Session | null,
  ];
  ...
  "llm/streamChat": [
    {
      ...
      completionOptions: LLMFullCompletionOptions;
      title: string;
      requestId?: string; // 재시도 시 서버 캐시 활용을 위한 요청 식별자
      modelDescription?: ModelDescription; // Full model info from API
  ...
  "tools/call": [
    { toolCall: ToolCall; modelDescription?: ModelDescription },
    {
