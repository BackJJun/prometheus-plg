...
export const DEFAULT_PROMPTS_FOLDER_V2 = ".prometheus/prompts";
export const DEFAULT_RULES_FOLDER = ".prometheus/rules";

// Subdirectory names (without .prometheus/ prefix)
