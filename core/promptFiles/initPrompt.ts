...
Create a comprehensive ${initFilename} file in the .prometheus/rules/ directory with the following sections:
...
## Step 4: Finalize
After creating the .prometheus/rules/${initFilename} file, provide a summary of what you've created and remind the user to:
