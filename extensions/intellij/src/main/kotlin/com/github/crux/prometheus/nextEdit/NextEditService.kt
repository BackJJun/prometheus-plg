package com.github.crux.prometheus.nextEdit
...
//                val nextEditItem = processedItem?.let { convertToNextEditItem(it) }
    ...
    private fun parseProcessedItem(response: Any?): ProcessedItem? {
        return try {
            ...
            val range = com.github.crux.prometheus.Range(startPosition, endPosition)
            val location = com.github.crux.prometheus.RangeInFile(filepath, range)
