package com.github.crux.prometheus.`continue`.file

import com.github.crux.prometheus.FileStats
import com.github.crux.prometheus.FileType
...
class FileUtils(
    ...
    fun openFile(fileUri: String) {
        LOG.warn("[Prometheus][openFile][IntelliJ] requested: $fileUri")
        val found = findFile(fileUri)
            ?: return LOG.warn("[Prometheus][openFile][IntelliJ] not found: $fileUri")
        LOG.warn("[Prometheus][openFile][IntelliJ] resolved: ${found.path}")
