...
import com.github.crux.prometheus.`continue`.process.ContinueBinaryProcess
import com.github.crux.prometheus.`continue`.process.ContinueProcessHandler
import com.github.crux.prometheus.`continue`.process.ContinueSocketProcess
...
class CoreMessenger(
    ...
    private fun handleMessage(json: String) {
        ...
        responseListeners[messageId]?.let { listener ->
            listener(data)
            val done = (data as? Map<*, *>)?.get("done") as? Boolean
