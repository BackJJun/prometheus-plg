...
val pluginGroup: String = "com.github.crux.prometheus"
...
tasks {
    ...
    test {
        useJUnitPlatform()
        environment("CONTINUE_GLOBAL_DIR", "${rootProject.projectDir}/src/test/kotlin/com/github/crux/prometheus/test-continue")
...
val testIntegration = task<Test>("testIntegration") {
    ...
    environment("CONTINUE_GLOBAL_DIR", "${rootProject.projectDir}/src/testIntegration/kotlin/com/github/crux/prometheus/test-continue")
    useJUnitPlatform()
