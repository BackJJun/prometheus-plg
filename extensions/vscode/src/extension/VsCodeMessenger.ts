...
export class VsCodeMessenger {
  ...
  constructor(
    ...
    this.onWebview("showFile", (msg) => {
      console.log(
        "[Prometheus][showFile][VSCode] filepath:",
        msg.data.filepath,
      );
    ...
    this.onWebview("workspace/open", (msg) => {
      vscode.commands.executeCommand(
        "vscode.openFolder",
        vscode.Uri.parse(msg.data),
        true,
      );
    });
    ...
    this.onWebviewOrCore("setLoginDialogOpen", async (msg) => {
      await vscode.commands.executeCommand(
        "setContext",
        "continue.loginDialogOpen",
        msg.data,
      );
    });
  }
